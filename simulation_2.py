...
if __name__ == '__main__':
    ...
    router_a_rt_tbl_D= {'1':{0:1, 1:'~', 2: '~', 3: '~'}, '2':{0: '~', 1: '~', 2: '~', 3: 1},
                         '3':{0:'~', 1: '~', 2: '~', 3:'~' },'A': {0:0, 1:0, 2:0, 3:0},'B':{0:'~', 1:'1', 2: '~', 3:'~'}, 'C': {0: '~', 1:'~', 2: '2', 3: '~'},
                        'D': {0: '~', 1: '~', 2: '~', 3:'~'}}

    router_b_rt_tbl_D= {'1':{0: '~', 1:'~'}, '2': {0:'~', 1:'~'}, '3': {0:'~', 1:'~'}, 'A': {0:1, 1: '~'}, 'B': {0:0, 1:0},
                        'C': {0: '~', 1:'~'}, 'D': {0: '~', 1:2}}

    router_c_rt_tbl_D = {'1': {0:'~', 1:'~'}, '2': {0: '~', 1:'~'}, '3': {0: '~',1:'~'},'A': {0:2, 1: '~'}, 'B': {0: '~',1:'~'},
                         'C': {0:0, 1:0},'D': {0: '~', 1:1}}

    router_d_rt_tbl_D= {'1':{0: '~', 1:'~', 2:'~'}, '2':{0: '~', 1:'~', 2:'~'}, '3': {0: '~', 1:'1', 2:'~'},
                        'A': {0: '~', 1:'~', 2:'~'}, 'B': {0: '2', 1:'~', 2:'~'}, 'C': {0: '~', 1:'~', 2:'1'}, 'D':{0:0, 1:0, 2:0},}
    ...
    for i in range(1):
        host_one.udt_send(2, 'Sample client data %d' % i)
